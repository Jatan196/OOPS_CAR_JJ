                ...
                try {
                    ...
                    while ((line = br.readLine()) != null) {
                        if (line.equals(e_id)) {
                            ...
                            Manager m = new Manager(e_id, e_pass, line = br.readLine(), line = br.readLine(),
                    ...
                    try {
                        ...
                        while ((line = br.readLine()) != null) {
                            if (line.equals(e_id)) {
                                ...
                                Supervisor m = new Supervisor(e_id, e_pass, line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(), (line = br.readLine()),
                                        (line = br.readLine()), (line = br.readLine()), line = br.readLine(),
                    ...
                    try {
                        ...
                        while ((line = brw.readLine()) != null) {
                            if (!line.equals(e_id)) {
                                ...
                                Engineer m = new Engineer(e_id, e_pass, line = brw.readLine(), line = brw.readLine(),
                                        line = brw.readLine(), line = brw.readLine(),
                                        line = brw.readLine(), line = brw.readLine(), line = brw.readLine(),
                                        line = brw.readLine(), line = brw.readLine(), (line = brw.readLine()),
                                        (line = brw.readLine()), (line = brw.readLine()), line = brw.readLine(),
                                        (line = brw.readLine()));
                    ...
                    try {
                        ...
                        while ((line = br.readLine()) != null) {
                            if (line.equals(e_id)) {
                                ...
                                Worker m = new Worker(e_id, e_pass, line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(), line = br.readLine(),
                                        line = br.readLine(), line = br.readLine(), (line = br.readLine()),
                                        (line = br.readLine()), (line = br.readLine()), line = br.readLine(),
